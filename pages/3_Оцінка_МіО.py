...
def load_mio_excel():
    ...
    try:
        ...
        log_exception("load_mio_sheet", exc)
        st.warning("Не вдалося завантажити аркуш з оцінкою МіО. Дані сторінки можуть бути неповними.")
        return pd.DataFrame(), {}
...
def load_excel_measure_exec_scores():
    ...
    try:
        ...
        log_exception("load_measures_sheet", exc)
        st.warning("Не вдалося завантажити довідник заходів. Дані сторінки можуть бути неповними.")
        return {}
