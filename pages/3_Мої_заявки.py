...
with st.expander("Перелік поданих відомостей", expanded=False):
    ...
    render_readonly_table(
        ...
        column_widths={
            ...
            "Захід": 300,
            "Звітний період": 125,
            "Цільовий орієнтир": 135,
            "Фактичне значення": 135,
            "Статус виконання": 170,
            "Статус погодження": 180,
            "Координатор": 300,
            "Номер телефону координатора": 300,
            "Коментар координатора": 300,
            "Дата подання": 300,
        },
        status_columns={"Статус виконання", "Статус погодження"},
        scroll_columns={"Захід", "Коментар координатора"},
        column_alignments={
            "Звітний період": "center",
            "Цільовий орієнтир": "center",
            "Фактичне значення": "center",
        },
    ...
    if versions_df.empty:
        ...
        render_readonly_table(
            ...
            column_widths={
                ...
                "Посилання на НПА": 240,
            },
            status_columns={"Статус погодження", "Статус виконання"},
            scroll_columns={"Захід", "Опис прогресу", "Ризики/проблеми/відхилення", "Посилання на НПА"},
            column_alignments={
                "Версія заявки": "center",
                "Цільовий орієнтир": "center",
                "Фактичне значення": "center",
            },
            enforce_column_widths=True,
