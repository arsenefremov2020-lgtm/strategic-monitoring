...
st.markdown(
    ...
    <div class="header-box">
        ...
        <div class="header-subtitle">
            Інтерактивна демо-версія системи для проведення моніторингу, оцінки результатів та актуалізації (перегляду) Стратегічного плану на 2026-2028 роки
        </div>
...
st.markdown(
    """
    <div class="cta-box">
        <div class="cta-title">Моніторинг і оцінка результатів виконання Стратегічного плану на 2026-2028 роки</div>
    </div>
    """,
    unsafe_allow_html=True
)
