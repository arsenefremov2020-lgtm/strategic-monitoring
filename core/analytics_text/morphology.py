...
ENTITY_FORMS: dict[str, Mapping[str, str]] = {
    ...
    "component": {
        "one": "компонент", "few": "компоненти", "many": "компонентів",
        "nom_sg": "компонент", "gen_sg": "компонента", "dat_sg": "компоненту", "acc_sg": "компонент", "ins_sg": "компонентом", "loc_sg": "компоненті",
        "nom_pl": "компоненти", "gen_pl": "компонентів", "dat_pl": "компонентам", "acc_pl": "компоненти", "ins_pl": "компонентами", "loc_pl": "компонентах",
    },
    "product_type": {
        "one": "тип продукту", "few": "типи продуктів", "many": "типів продуктів",
        "nom_sg": "тип продукту", "gen_sg": "типу продукту", "dat_sg": "типу продукту", "acc_sg": "тип продукту", "ins_sg": "типом продукту", "loc_sg": "типі продукту",
        "nom_pl": "типи продуктів", "gen_pl": "типів продуктів", "dat_pl": "типам продуктів", "acc_pl": "типи продуктів", "ins_pl": "типами продуктів", "loc_pl": "типах продуктів",
    },
    "period": {
