...
st.markdown("""
<style>
/* Повноекранний прозорий шар для iframe з пташкою.
   Це прибирає поведінку "окремого блоку внизу" і кладе чат поверх усієї сторінки. */
...
_components.html(_chat_html, height=1, scrolling=False)
