...
NOTIFICATION_TYPE_LABELS = {
    "stage_assigned": "Заявка надійшла на поточну ланку",
    "manager_selection_required": "Подавачу потрібно обрати керівника",
    "returned": "Заявку повернуто на доопрацювання",
